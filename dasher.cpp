...
int main()
{
  ...
  for (int i = 0; i < sizeOfNebulae; i++)
  {
    ...
    nebulae[i].pos.x = windowDimensions[0] + nebulaOffset * i;
  };
  

  float finishLine{ nebulae[sizeOfNebulae - 1].pos.x};
  // nebula X velocity (pixes/second)
  ...
  while (!WindowShouldClose())
  {
    ...
    else if (scarfyData.pos.x >= finishLine)
    {
      // win the game
      {
        DrawText("You Win!", windowDimensions[0]/2 - 80, windowDimensions[1]/2, 36, RED);
      }
    }
    else
    {
